      ...
      {hasGenericFallback && (
        <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900/50 dark:bg-yellow-900/20">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-300">Generic Fallback Parser Used</h3>
              <p className="mt-1 text-sm text-yellow-700 dark:text-yellow-400">
                Some files could not be uniquely identified and were parsed using a generic fallback method. Please
                verify the imported amounts and dates carefully.
              </p>
            </div>
          </div>
        </div>
